...
gulp.task('scripts', function() {
  return gulp.src([
    ...
    'assets/js/vendor/photoswipe.min.js',
    'assets/js/vendor/photoswipe-ui-default.min.js',
...
gulp.task('merge-styles', function () {
    ...
    return gulp.src([
        ...
        'assets/css/vendor/bootstrap-datepicker.css',
        'assets/css/vendor/default-skin.css',
...
gulp.task('default', ['sass', 'scripts', 'browser-sync'], function () {
    ...
    gulp.watch(['assets/js/custom.js'], ['minify-custom'])
